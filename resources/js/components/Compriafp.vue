...
<div class="right_col" role="main">
          ...
          <div class="row">
                ...
                <div class="x_content">
               <button type="button" @click="abrirModaladminpensiones('registrar')" class="btn btn-primary float-right">
                            <i class="icon-plus"></i>&nbsp;Nuevo
                </button>
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                        <select class="form-control" v-model="cpsperiodo" @change="listarcompriseg(cpsperiodo)">
                            <option value="0" disabled>Seleccione Periodo</option>
                            <option v-for="periodo in arrayPeriodos" :key="periodo.cpsperiodo" :value="periodo.cpsperiodo" v-text="periodo.cpsperiodo"></option>
                        </select>
                    </div>
                </div>
